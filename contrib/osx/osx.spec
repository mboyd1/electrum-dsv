...
a = Analysis([electrum+ MAIN_SCRIPT,
              electrum+'electrum_dsv/gui/qt/main_window.py',
              electrum+'electrum_dsv/gui/text.py',
              electrum+'electrum_dsv/util.py',
              electrum+'electrum_dsv/wallet.py',
              electrum+'electrum_dsv/simple_config.py',
              electrum+'electrum_dsv/bitcoin.py',
              electrum+'electrum_dsv/blockchain.py',
              electrum+'electrum_dsv/dnssec.py',
              electrum+'electrum_dsv/commands.py',
              electrum+'electrum_dsv/plugins/cosigner_pool/qt.py',
              electrum+'electrum_dsv/plugins/email_requests/qt.py',
              electrum+'electrum_dsv/plugins/trezor/qt.py',
              electrum+'electrum_dsv/plugins/safe_t/client.py',
              electrum+'electrum_dsv/plugins/safe_t/qt.py',
              electrum+'electrum_dsv/plugins/keepkey/qt.py',
              electrum+'electrum_dsv/plugins/ledger/qt.py',
              electrum+'electrum_dsv/plugins/coldcard/qt.py',
              ],
             binaries=binaries,
             datas=datas,
