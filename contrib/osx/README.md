...
This guide explains how to build Electrum-DSV binaries for macOS systems.
...
#### 2. Build Electrum-DSV

    cd electrum-dsv
    ./contrib/osx/make_osx

This creates both a folder named Electrum-DSV.app and the .dmg file.
