...
```
$ adb -d install -r bin/Electrum-DSV-*-arm64-v8a-debug.apk
$ adb shell monkey -p org.electrum_dsv.electrum_dsv 1
```
...
```
adb logcat | grep -F "`adb shell ps | grep org.electrum_dsv.electrum_dsv | cut -c14-19`"
```
...
Run electrum with the `-g` switch: `electrum-dsv -g kivy`
...
```
$ adb shell
$ run-as org.electrum_dsv.electrum_dsv ls /data/data/org.electrum_dsv.electrum_dsv/files/data
$ run-as org.electrum_dsv.electrum_dsv cp /data/data/org.electrum_dsv.electrum_dsv/files/data/wallets/my_wallet /sdcard/some_path/my_wallet
```
