...
# (str) Package name
package.name = Electrum_DSV

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrum_dsv
...
source.exclude_dirs = bin, build, dist, contrib,
    electrum_dsv/tests,
    electrum_dsv/gui/qt,
    electrum_dsv/gui/kivy/theming/light,
    packages/qdarkstyle,
    packages/qtpy
...
version.filename = %(source.dir)s/electrum_dsv/version.py
...
presplash.filename = %(source.dir)s/electrum_dsv/gui/icons/electrum_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/electrum_dsv/gui/icons/electrum_launcher.png
...
android.add_src = electrum_dsv/gui/kivy/data/java-classes/
