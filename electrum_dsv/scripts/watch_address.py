...
from electrum_dsv.util import print_msg, create_and_start_event_loop
from electrum_dsv.synchronizer import SynchronizerBase
...
try:
    ...
    print("usage: watch_address <doriancoin_address>")
    sys.exit(1)
