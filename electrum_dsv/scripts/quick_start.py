...
from electrum_dsv.wallet import Wallet, create_new_wallet
from electrum_dsv.wallet_db import WalletDB
from electrum_dsv.commands import Commands
from electrum_dsv.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-dsv/testnet as datadir
