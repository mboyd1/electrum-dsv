...
from electrum_dsv.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from electrum_dsv.invoices import (PR_TYPE_ONCHAIN, PR_TYPE_LN, PR_DEFAULT_EXPIRATION_WHEN_CREATING,
                                   PR_PAID, PR_UNKNOWN, PR_EXPIRED, PR_INFLIGHT,
                                   LNInvoice, pr_expiration_values, Invoice, OnchainInvoice)
from electrum_dsv import bitcoin, constants
from electrum_dsv.transaction import Transaction, tx_from_any, PartialTransaction, PartialTxOutput
from electrum_dsv.util import parse_URI, InvalidBitcoinURI, TxMinedInfo, maybe_extract_bolt11_invoice
from electrum_dsv.plugin import run_hook
from electrum_dsv.wallet import InternalAddressCorruption
from electrum_dsv import simple_config
from electrum_dsv.simple_config import FEERATE_WARNING_HIGH_FEE, FEE_RATIO_HIGH_WARNING
from electrum_dsv.lnaddr import lndecode
from electrum_dsv.lnutil import RECEIVED, SENT, PaymentFailure
from electrum_dsv.logging import Logger

from .dialogs.question import Question
from .dialogs.lightning_open_channel import LightningOpenChannelDialog

from electrum_dsv.gui.kivy import KIVY_GUI_PATH
from electrum_dsv.gui.kivy.i18n import _

if TYPE_CHECKING:
    from electrum_dsv.gui.kivy.main_window import ElectrumWindow
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_dsv.util import create_bip21_uri
        amount = self.amount
        if amount:
