...
from electrum_dsv.util import is_valid_email
...
#:import _ electrum_dsv.gui.kivy.i18n._
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_dsv.mnemonic import Mnemonic
        from electrum_dsv.old_mnemonic import wordlist as old_wordlist
    ...
    def update_next_button(self):
        from electrum_dsv.keystore import bip39_is_checksum_valid
        text = self.get_text()
        if self.is_bip39:
