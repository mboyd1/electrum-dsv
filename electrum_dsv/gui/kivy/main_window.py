...
from electrum_dsv.storage import WalletStorage, StorageReadWriteError
from electrum_dsv.wallet_db import WalletDB
from electrum_dsv.wallet import Wallet, InternalAddressCorruption, Abstract_Wallet
from electrum_dsv.plugin import run_hook
from electrum_dsv import util
from electrum_dsv.util import (profiler, InvalidPassword, send_exception_to_crash_reporter,
                               format_satoshis, format_satoshis_plain, format_fee_satoshis,
                               maybe_extract_bolt11_invoice)
from electrum_dsv.invoices import PR_PAID, PR_FAILED
from electrum_dsv import blockchain
from electrum_dsv.network import Network, TxBroadcastError, BestEffortRequestFailed
from electrum_dsv.interface import PREFERRED_NETWORK_PROTOCOL, ServerAddr
...
#Factory.register('InstallWizard', module='electrum_dsv.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_dsv.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_dsv.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_dsv.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_dsv_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_dsv.gui.kivy.uix.screens')
...
from electrum_dsv.util import (NoDynamicFeeEstimates, NotEnoughFunds,
...
if TYPE_CHECKING:
    ...
    from electrum_dsv.plugin import Plugins
    from electrum_dsv.paymentrequest import PaymentRequest
...
class ElectrumWindow(App, Logger):
    ...
    def on_qr(self, data):
        from electrum_dsv.bitcoin import is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_dsv.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_dsv.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_dsv_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_dsv_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = os.path.dirname(KIVY_GUI_PATH) + "/icons/electrum-dsv.png"
    ...
    def get_max_amount(self):
        from electrum_dsv.transaction import PartialTxOutput
