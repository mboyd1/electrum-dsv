...
from electrum_dsv import WalletStorage, Wallet
from electrum_dsv.wallet_db import WalletDB
from electrum_dsv.util import format_satoshis
from electrum_dsv.bitcoin import is_address, COIN
from electrum_dsv.transaction import PartialTxOutput
from electrum_dsv.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-dsv create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-dsv setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-dsv setconfig' to change your settings")
        return True
