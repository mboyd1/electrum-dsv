...
API_URL_MAINNET = 'https://swaps.doriancoin.org/api'
API_URL_TESTNET = 'https://swaps.doriancoin.org/testnet'
...
class SwapManager(Logger):
    ...
    async def get_pairs(self) -> None:
        ...
        limits = pairs['pairs']['DSV/DSV']['limits']
