...
from electrum_dsv import bip32, constants
...
from electrum_dsv.wallet import Standard_Wallet, Multisig_Wallet, Deterministic_Wallet
from electrum_dsv.util import bh2u, UserFacingException
from electrum_dsv.base_wizard import ScriptTypeNotSupported, BaseWizard
from electrum_dsv.logging import get_logger
from electrum_dsv.plugin import Device, DeviceInfo, runs_in_hwd_thread
from electrum_dsv.simple_config import SimpleConfig
from electrum_dsv.json_db import StoredDict
from electrum_dsv.storage import get_derivation_used_for_hw_device_encryption
from electrum_dsv.bitcoin import OnchainOutputType

import electrum_dsv.bitcoin as bitcoin
import electrum_dsv.ecc as ecc
...
class BitBox02Client(HardwareClientBase):
    ...
    def coin_network_from_electrum_network(self) -> int:
        if constants.net.TESTNET:
            return bitbox02.btc.TDSV
        return bitbox02.btc.DSV
    ...
    def get_xpub(self, bip32_path: str, xtype: str, *, display: bool = False) -> str:
        ...
        if xtype == "p2wpkh":
            if coin_network == bitbox02.btc.DSV:
    ...
    def _get_coin(self):
        return bitbox02.btc.TDSV if constants.net.TESTNET else bitbox02.btc.DSV
