...
from electrum_dsv.bitcoin import (public_key_to_p2pkh, address_from_private_key,
...
from electrum_dsv.bip32 import (BIP32Node, convert_bip32_intpath_to_strpath,
                                xpub_from_xprv, xpub_type, is_xprv, is_bip32_derivation,
                                is_xpub, convert_bip32_path_to_list_of_uint32,
                                normalize_bip32_derivation, is_all_public_derivation)
from electrum_dsv.crypto import sha256d, SUPPORTED_PW_HASH_VERSIONS
from electrum_dsv import ecc, crypto, constants
from electrum_dsv.util import bfh, bh2u, InvalidPassword, randrange
from electrum_dsv.storage import WalletStorage
from electrum_dsv.keystore import xtype_from_derivation

from electrum_dsv import ecc_fast
...
class Test_bitcoin(ElectrumTestCase):
    ...
    def test_address_to_script(self):
        ...
        self.assertEqual(address_to_script('DSV1QW508D6QEJXTDG4Y5R3ZARVARY0C5XW7KGMN4N9'), '0014751e76e8199196d454941c45d1b3a323f1433bd6')
        self.assertEqual(address_to_script('dsv1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7k0tul4w'), '5128751e76e8199196d454941c45d1b3a323f1433bd6751e76e8199196d454941c45d1b3a323f1433bd6')
        self.assertEqual(address_to_script('DSV1SW50QZGYDF5'), '6002751e')
        self.assertEqual(address_to_script('dsv1zw508d6qejxtdg4y5r3zarvaryvdzur3w'), '5210751e76e8199196d454941c45d1b3a323')
...
class Test_bitcoin_testnet(TestCaseForTestnet):
    ...
    def test_address_to_script(self):
        # bech32 native segwit
        # test vectors from BIP-0173
        self.assertEqual(address_to_script('tdsv1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3qsnr4fp'), '00201863143c14c5166804bd19203356da136c985678cd4d27a1b8c6329604903262')
        self.assertEqual(address_to_script('tdsv1qqqqqp399et2xygdj5xreqhjjvcmzhxw4aywxecjdzew6hylgvsesu9tmgm'), '0020000000c4a5cad46221b2a187905e5266362b99d5e91c6ce24d165dab93e86433')
...
class Test_keyImport(ElectrumTestCase):
    ...
    priv_pub_addr = (
           ...
           {'priv': 'L8g5V8kFFeg2WbecahRSdobARbHz2w2STH9S8ePHVSY4fmia7Rsj',
            ...
            'address': 'dsv1qqmpt7u5e9hfznljta5gnvhyvfd2kdd0rpnd2yf',
            'minikey': False,
            'txin_type': 'p2wpkh',
            'compressed': True,
           ...
           {'priv': 'p2wpkh:T53nQpon8i8fuQHkEejzyQMYA8Gc813w2XeKcvKfkBG9jCjWvCGN',
            ...
            'address': 'dsv1qpakeeg4d9ydyjxd8paqrw4xy9htsg532z7uhvl',
            'minikey': False,
            'txin_type': 'p2wpkh',
            'compressed': True,
            'addr_encoding': 'bech32',
    ...
    def test_is_address_bad_checksums(self):
        ...
        self.assertTrue(is_address('dsv1qxq64lrwt02hm7tu25lr3hm9tgzh58snfaxyqn2'))
        self.assertFalse(is_address('dsv1qxq64lrwt02hm7tu25lr3hm9tgzh58snfaxyqn1'))
