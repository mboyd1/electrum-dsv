...
from electrum_dsv.util import create_and_start_event_loop
from electrum_dsv.commands import Commands, eval_bool
from electrum_dsv import storage, wallet
from electrum_dsv.wallet import restore_wallet_from_text
...
class TestCommands(ElectrumTestCase):
    ...
    def test_export_private_key_imported(self, mock_save_db):
        ...
        with self.assertRaises(Exception):
            cmds._run('getprivatekeys', ("dsv1qgfam82qk7uwh5j2xxmcd8cmklpe0zackqwq8jp",), wallet=wallet)  # not in wallet
        self.assertEqual("p2wpkh:TAa25Tq4PdzhDKBoVaFaCdV3yxvLrRikQviNkuFQLeYopsVvNTV3",
                         cmds._run('getprivatekeys', ("dsv1q2ccr34wzep58d4239tl3x3734ttle92arvely7",), wallet=wallet))
        # list of addresses tests
        with self.assertRaises(Exception):
            cmds._run('getprivatekeys', (['dsv1q2ccr34wzep58d4239tl3x3734ttle92arvely7', 'asd'], ), wallet=wallet)
        self.assertEqual(['p2wpkh:TAa25Tq4PdzhDKBoVaFaCdV3yxvLrRikQviNkuFQLeYopsVvNTV3', 'p2wpkh:TAgoypi14k5Y54svysG62xp5QFRWiF1W64zxaFRFPo2jMPSMoa5D'],
                         cmds._run('getprivatekeys', (['dsv1q2ccr34wzep58d4239tl3x3734ttle92arvely7', 'dsv1q9pzjpjq4nqx5ycnywekcmycqz0wjp2nq7n0qjr'], ), wallet=wallet))
    ...
    def test_export_private_key_deterministic(self, mock_save_db):
        ...
        self.assertEqual("p2wpkh:T6v5Q8KEmjLmJoTxPfXfyNcCEFYC7Lfmwmp9Y8dce9knevo9ZkPk",
                         cmds._run('getprivatekeys', ("dsv1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e",), wallet=wallet))
        # list of addresses tests
        with self.assertRaises(Exception):
            cmds._run('getprivatekeys', (['dsv1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e', 'asd'],), wallet=wallet)
        self.assertEqual(['p2wpkh:T6v5Q8KEmjLmJoTxPfXfyNcCEFYC7Lfmwmp9Y8dce9knevo9ZkPk', 'p2wpkh:TAgoypi14k5Y54svysG62xp5QFRWiF1W64zxaFRFPo2jMPSMoa5D'],
                         cmds._run('getprivatekeys', (['dsv1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e', 'dsv1q9pzjpjq4nqx5ycnywekcmycqz0wjp2nq7n0qjr'], ), wallet=wallet))
...
class TestCommandsTestnet(TestCaseForTestnet):
    ...
    def test_serialize(self):
        ...
        jsontx = {
            ...
            "outputs": [
                {
                    "address": "tdsv1q4s8z6g5jqzllkgt8a4har94wl8tg0k9m77w2jy",
                    "value": 990000
                }
            ]
        }
