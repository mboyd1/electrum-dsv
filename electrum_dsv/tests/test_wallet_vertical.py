...
from electrum_dsv import storage, bitcoin, keystore, bip32, wallet
from electrum_dsv import Transaction
from electrum_dsv import SimpleConfig
from electrum_dsv.address_synchronizer import TX_HEIGHT_UNCONFIRMED, TX_HEIGHT_UNCONF_PARENT
from electrum_dsv.wallet import sweep, Multisig_Wallet, Standard_Wallet, Imported_Wallet, restore_wallet_from_text, Abstract_Wallet
from electrum_dsv.util import bfh, bh2u, create_and_start_event_loop
from electrum_dsv.transaction import TxOutput, Transaction, PartialTransaction, PartialTxOutput, PartialTxInput, tx_from_any
from electrum_dsv.mnemonic import seed_type
...
class TestWalletKeystoreAddressIntegrityForMainnet(ElectrumTestCase):
    ...
    def test_electrum_seed_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'dsv1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e')
        self.assertEqual(w.get_change_addresses()[0], 'dsv1qdy94n2q5qcp0kg7v9yzwe6wvfkhnvyzjazfzj3')
    ...
    def test_electrum_seed_segwit_passphrase(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'dsv1qx94dutas7ysn2my645cyttujrms5d9p564qe9t')
        self.assertEqual(w.get_change_addresses()[0], 'dsv1qcywwsy87sdp8vz5rfjh3sxdv6rt95kujfu64lc')
    ...
    def test_bip39_seed_bip84_native_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'dsv1qcr8te4kr609gcawutmrza0j4xv80jy8z4nqduv')
        self.assertEqual(w.get_change_addresses()[0], 'dsv1q8c6fshw2dlwun7ekn9qwf37cu2rn755u9ym7p0')
    ...
    def test_electrum_multisig_seed_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'dsv1qvzezdcv6vs5h45ugkavp896e0nde5c5lg5h0fwe2xyfhnpkxq6gqa9a79a')
        self.assertEqual(w.get_change_addresses()[0], 'dsv1qxqf840dqswcmu7a8v82fj6ej0msx08flvuy6kngr7axstjcaq6usxndfdg')
    ...
    def test_bip32_extended_version_bytes(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'dsv1qtuynwzd0d6wptvyqmc6ehkm70zcamxpsncccvf')
        self.assertEqual(w.get_change_addresses()[0], 'dsv1qjy5zunxh6hjysele86qqywfa437z4xwmm96rkx')
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'dsv1q84x0yrztvcjg88qef4d6978zccxulcmc9y88xcg4ghjdau999x7qaxz66u')
        self.assertEqual(w.get_change_addresses()[0], 'dsv1q0fj5mra96hhnum80kllklc52zqn6kppt3hyzr49yhr3ecr42z3tsqjxpj4')
...
class TestWalletKeystoreAddressIntegrityForTestnet(TestCaseForTestnet):
    ...
    def test_bip32_extended_version_bytes(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'tdsv1qtuynwzd0d6wptvyqmc6ehkm70zcamxpsy2m3lr')
        self.assertEqual(w.get_change_addresses()[0], 'tdsv1qjy5zunxh6hjysele86qqywfa437z4xwmvhe29v')
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'tdsv1q84x0yrztvcjg88qef4d6978zccxulcmc9y88xcg4ghjdau999x7qkfxy9f')
        self.assertEqual(w.get_change_addresses()[0], 'tdsv1q0fj5mra96hhnum80kllklc52zqn6kppt3hyzr49yhr3ecr42z3tstazldq')
...
class TestWalletSending(TestCaseForTestnet):
    ...
    def _bump_fee_p2wpkh_when_there_is_only_a_single_output_and_that_is_a_change_address(self, *, simulate_moving_txs, config):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value('tdsv1q7rl9cxr85962ztnsze089zs8ycv52hk4gpn946', '!')]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(coins=coins, outputs=outputs, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325499
    ...
    def _rbf_batching(self, *, simulate_moving_txs, config):
        ...
        outputs = [PartialTxOutput.from_address_and_value('tdsv1qy6xmdj96v5dzt3j08hgc05yk3kltqsnmhapynd', 2_500_000)]
        coins = wallet.get_spendable_coins(domain=None)
    ...
    def test_sweep_p2pk(self):
        ...
        network = NetworkMock()
        dest_addr = 'tdsv1q3ws2p0qjk5vrravv065xqlnkckvzcpcl0k88vr'
    ...
    def test_coinjoin_between_two_p2wpkh_electrum_seeds(self, mock_save_db):
        ...
        outputs = [PartialTxOutput.from_address_and_value("tdsv1qhye4wfp26kn0l7ynpn5a4hvt539xc3zfkmuymc", 10_000_000)]
        ...
        outputs = [PartialTxOutput.from_address_and_value("tdsv1qufnj5k2rrsnpjq7fg6d2pq3q9um6skdya34syj", 10_000_000)]
    ...
    def test_standard_wallet_cannot_sign_multisig_input_even_if_cosigner(self, mock_save_db):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value('tdsv1qfrlx5pza9vmez6vpx7swt8yp0nmgz3qa86sgvq', 100_000)]
        ...
        self.assertEqual('tdsv1qxq5crk6yadw66rdt8xr3xj5ctvmq4c3z0fl85yx0ar8l6ga6ehysfvlnuf', tx.inputs()[0].address)
        self.assertEqual('tdsv1qfrlx5pza9vmez6vpx7swt8yp0nmgz3qa86sgvq',                     tx.outputs()[0].address)
        self.assertEqual('tdsv1qadpg5z77egkpkde34mdcrsz3s3tgwk5ew4w3wlfqf4j3dk8kkvrswgd6vs', tx.outputs()[1].address)
...
class TestWalletOfflineSigning(TestCaseForTestnet):
    ...
    def test_sending_offline_old_electrum_seed_online_mpk(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value('tdsv1qyw3c0rvn6kk2c688y3dygvckn57525y8emy4p5', 2500000)]
    ...
    def test_sending_offline_xprv_online_xpub_p2pkh(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value('tdsv1qp0mv2sxsyxxfj5gl0332f9uyez93su9cszcqyh', 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325340
        tx.version = 1
    ...
    def test_sending_offline_wif_online_addr_p2pkh(self, mock_save_db):  # compressed pubkey
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value('tdsv1quk7ahlhr3qmjndy0uvu9y9hxfesrtahtj48k8j', 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325340
        tx.version = 1
    ...
    def test_sending_offline_wif_online_addr_p2wpkh(self, mock_save_db):
        ...
        wallet_online = WalletIntegrityHelper.create_imported_wallet(privkeys=False, config=self.config)
        wallet_online.import_address('tdsv1qm2eh4787lwanrzr6pf0ekf5c7jnmghm2ad526v')
    ...
    def test_sending_offline_hd_multisig_online_addr_p2wsh(self, mock_save_db):
        ...
        # ^ third seed: hedgehog sunset update estate number jungle amount piano friend donate upper wool
        wallet_online = WalletIntegrityHelper.create_imported_wallet(privkeys=False, config=self.config)
        wallet_online.import_address('tdsv1q83p6eqxkuvq4eumcha46crpzg4nj84s9p0hnynkxg8nhvfzqcc7q26lnr9')
...
class TestWalletHistory_EvilGapLimit(TestCaseForTestnet):
    ...
    def test_restoring_wallet_txorder1(self, mock_save_db):
        ...
        w.receive_history_callback('tdsv1qgh5c088he4d559wl0hw27hrdeg8p2z96c3td9f',  # HD index 1
                                   [('268fce617aaaa4847835c2212b984d7b7741fdab65de22813288341819bc5656', 1316917)],
                                   {})
        w.synchronize()
        w.receive_history_callback('tdsv1qm0ejr6g964zt2jux5te7m9ds43n28hds528z0k',  # HD index 3
                                   [('511a35e240f4c8855de4c548dad932d03611a37e94e9203fdb6fc79911fe1dd4', 1316912)],
                                   {})
        w.synchronize()
        w.receive_history_callback('tdsv1qj4pnq958k89zcem3342lhcgyz0rnmhkzxjy3gk',  # HD index 4
                                   [('fde0b68938709c4979827caa576e9455ded148537fdb798fd05680da64dc1b4f', 1316917)],
                                   {})
        w.synchronize()
        w.receive_history_callback('tdsv1q3pyjwpm8wxgvquak240mprfhaydmkawcfhg2zs',  # HD index 15
                                   [('511a35e240f4c8855de4c548dad932d03611a37e94e9203fdb6fc79911fe1dd4', 1316912)],
                                   {})
        w.synchronize()
        w.receive_history_callback('tdsv1qr0qjp99ygawul0eylxfqmt7alygye22mtenjfm',  # HD index 25
                                   [('fde0b68938709c4979827caa576e9455ded148537fdb798fd05680da64dc1b4f', 1316917),
                                    ('268fce617aaaa4847835c2212b984d7b7741fdab65de22813288341819bc5656', 1316917)],
                                   {})
        w.synchronize()
