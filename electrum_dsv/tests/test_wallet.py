...
from electrum_dsv.exchange_rate import ExchangeBase, FxThread
from electrum_dsv.util import TxMinedInfo, InvalidPassword
from electrum_dsv.bitcoin import COIN
...
class TestCreateRestoreWallet(WalletTestCase):
    ...
    def test_restore_wallet_from_text_mnemonic(self):
        ...
        self.assertEqual(encrypt_file, wallet.storage.is_encrypted())
        self.assertEqual('dsv1q2ccr34wzep58d4239tl3x3734ttle92arvely7', wallet.get_receiving_addresses()[0])
    ...
    def test_restore_wallet_from_text_addresses(self):
        text = 'dsv1q2ccr34wzep58d4239tl3x3734ttle92arvely7 dsv1qnp78h78vp92pwdwq5xvh8eprlga5q8gu7xl7hg'
        ...
        wallet.delete_address('dsv1qnp78h78vp92pwdwq5xvh8eprlga5q8gu7xl7hg')
    ...
    def test_restore_wallet_from_text_privkeys(self):
        ...
        self.assertEqual('dsv1q2ccr34wzep58d4239tl3x3734ttle92arvely7', addr0)
