...
from electrum_dsv import constants, blockchain
from electrum_dsv.simple_config import SimpleConfig
from electrum_dsv.blockchain import Blockchain, deserialize_header, hash_header
from electrum_dsv.util import bh2u, bfh, make_dir
...
class TestVerifyHeader(ElectrumTestCase):
    ...
    # Data for Doriancoin block header #100.
