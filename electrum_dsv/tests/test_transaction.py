...
from electrum_dsv import transaction, bitcoin
from electrum_dsv.transaction import (convert_raw_tx_to_hex, tx_from_any, Transaction,
                                      PartialTransaction, TxOutpoint, PartialTxInput,
                                      PartialTxOutput)
from electrum_dsv.util import bh2u, bfh
from electrum_dsv.bitcoin import (deserialize_privkey, opcodes,
...
class TestTransaction(ElectrumTestCase):
    ...
    def test_estimated_output_size(self):
        ...
        self.assertEqual(estimated_output_size('dsv1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e'), 31)
        self.assertEqual(estimated_output_size('dsv1qnvks7gfdu72de8qv6q6rhkkzu70fqz4wpjzuxjf6aydsx7wxfwcqsmgvk5'), 43)
    ...
    def test_get_address_from_output_script(self):
        ...
        self.assertEqual('dsv1qw508d6qejxtdg4y5r3zarvary0c5xw7kgmn4n9', addr_from_script('0014751e76e8199196d454941c45d1b3a323f1433bd6'))
        self.assertEqual('dsv1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7k0tul4w', addr_from_script('5128751e76e8199196d454941c45d1b3a323f1433bd6751e76e8199196d454941c45d1b3a323f1433bd6'))
        self.assertEqual('dsv1sw50qzgydf5', addr_from_script('6002751e'))
        self.assertEqual('dsv1zw508d6qejxtdg4y5r3zarvaryvdzur3w', addr_from_script('5210751e76e8199196d454941c45d1b3a323'))
...
class TestTransactionTestnet(TestCaseForTestnet):
    ...
    def test_spending_op_cltv_p2sh(self):
        ...
        txout = PartialTxOutput.from_address_and_value(
            'tdsv1qv9hg20f0g08d460l67ph6p4ukwt7m0tte2sqtl', sats_less_fees)
    ...
    def test_spending_op_cltv_p2wsh(self):
        ...
        self.assertEqual("tdsv1q9dn6qke9924xe3zmptmhrdge0s043pjxpjndypgnu2t9fvsd4crs4rwaxu", from_addr)
        ...
        # Build the Transaction Output
        txout = PartialTxOutput.from_address_and_value(
            'tdsv1qtgsfkgptcxdn6dz6wh8c4dguk3cezwned6kx9h', sats_less_fees)
